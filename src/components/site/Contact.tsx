              ...
              {contactLocations.map((location, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Label + Title */}
                    <p className="relative mt-4 text-sm font-medium text-gray-500">Legacy Group International</p>
                    <h3 className="relative text-xl font-semibold text-[#071330]">{location.title}</h3>
